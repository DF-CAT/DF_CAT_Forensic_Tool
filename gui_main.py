...
bt9 = Checkbutton(frame_bot, text="History and Download History", variable=history, font=font)
...
bt16 = Checkbutton(frame_bot, text="Outlook", variable=outlook, font=font)
